/// The Zugantor Design System library.
///
/// This library provides a comprehensive set of themeable widgets and utilities
/// to build consistent and beautiful Flutter applications.
library zugantor_design_system;

// Themes
export 'src/theme/colors.dart';
export 'src/theme/custom_theme.dart';
export 'src/theme/shape.dart';
